...
export class ChangeFleetService {
  constructor({
    ...
    this.supervisionOrchestrator = new SupervisionOrchestrator({
      ...
      resumeWorkUnitValidation: (changeSetId, workUnitId) =>
        this.resumeWorkUnitValidation(changeSetId, workUnitId),
  ...
  async resumeWorkUnitValidation(
    ...
    const repositoryEvidence =
      await this.verificationOrchestrator.ensureRepositoryValidationPassed({
      changeSetId,
      workUnitId,
      workUnit,
      checkpoint,
  ...
  async ensureIndependentVerificationPassed({
    ...
    try {
      ...
      checkResult = await this.verificationOrchestrator.executeVerificationRequestedChecks({
        changeSetId,
        workUnitId,
        checkpoint,
        repository,

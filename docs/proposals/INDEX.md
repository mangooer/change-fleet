...
| [0014](0014-local-review-and-delivery-console.md) | Foreground local review and delivery console | `accepted` | Recorded by Decision 0016; bounded loopback UI and HTTP adapter over shared Bundle, audit, and delivery semantics | [WI-0009](../work-items/WI-0009-local-review-and-delivery-console.md), `review_ready` |

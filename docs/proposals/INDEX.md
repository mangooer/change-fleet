...
| [0027](0027-optional-project-semantic-checks.md) | Optional project semantic checks with mandatory structural preflight | `accepted` | Recorded by Decision 0029; revises Decision 0006's universal command presence while preserving exact structural evidence | [WI-0035](../work-items/WI-0035-optional-project-semantic-checks.md), `review` |
